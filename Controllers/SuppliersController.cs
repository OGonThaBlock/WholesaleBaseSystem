...
namespace WholesaleBase.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Supplier_id,Name,PhoneNumber")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Supplier_id,Name,PhoneNumber")] Supplier supplier)
        {
